...
class AE(N.Module):
    ...
    def forward(self, x0):
        ...
        x7 = T.tanh(self.encoder_7(x6))

        encoded = self.encoder_s(x7)
        ...
        x14 = T.sigmoid(self.decoder_7(x13))
...
optimizer = O.Adam(full_model.parameters(), lr=1e-3)
